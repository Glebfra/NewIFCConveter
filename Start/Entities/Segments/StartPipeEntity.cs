...
namespace Start.Entities.Segments
{
    ...
    /// Inherits from <see cref="StartAbstractSegmentEntity"/> and implements the <see cref="IStartMaterializedEntity"/> interface.
    /// </summary>
        ...
        IStartMaterializedEntity
    {
        ...
        [JsonConverter(typeof(JsonStartConverter<MassValueProperty<double>>))]
        public IStartValueProperty<double> AdditionalWeightLoadAlongTheXAxis { get; set; } = new MassValueProperty<double>();
        ...
        [JsonConverter(typeof(JsonStartConverter<MassValueProperty<double>>))]
        public IStartValueProperty<double> AdditionalWeightLoadAlongTheYAxis { get; set; } = new MassValueProperty<double>();
        ...
        [JsonConverter(typeof(JsonStartConverter<MassValueProperty<double>>))]
        public IStartValueProperty<double> AdditionalWeightLoadAlongTheZAxis { get; set; } = new MassValueProperty<double>();
    }
}