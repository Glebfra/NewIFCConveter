...
namespace Start.Interfaces
{
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description>Basic identification (ID, Name)</description></item>
    /// <item><description>Graph connectivity via <see cref="ConnectedEntities"/></description></item>
    /// <item><description>Structured metadata export via <see cref="GetData"/></description></item>
    /// </list>
    /// <para>
    ...
    public interface IStartEntity
    {
        ...
        /// </para>
        /// <list type="bullet">
        /// <item><description>Pipe → connected nodes</description></item>
        /// <item><description>Reducer → connected pipe segments</description></item>
        /// <item><description>Node → connected elements</description></item>
        /// </list>
        /// <para>
        ...
        /// </para>
        /// <list type="bullet">
        /// <item><description>Serialization</description></item>
        /// <item><description>Logging</description></item>
        /// <item><description>Debugging</description></item>
        /// <item><description>Export to external formats</description></item>
        /// </list>
        /// <para>
